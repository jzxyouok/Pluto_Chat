...
import com.wl.pluto.plutochat.chat.adapter.ExpressionAdapter;
import com.wl.pluto.plutochat.chat.common_interface.OnExpressionPressListener;
import com.wl.pluto.plutochat.chat.widget.GestureGridView;
...
public class ExpressionFragment2 extends Fragment {
     ...
     * 表情个数
     */
    private static final int EXPRESSION_COUNT = 35;
    ...
    private void initExpressionList() {
        ...
        //先选二十个出来看看
        for (int i = 21; i <= EXPRESSION_COUNT; i++) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View fragmentLayout = inflater.inflate(R.layout.fragment_expression_fragment2, container, false);
    ...
    private void initLayout(final View layout) {
        ...
        mExpressionGridView = (GestureGridView) layout.findViewById(R.id.gv_expression_grid_view2);
