...
import com.wl.pluto.plutochat.chat.adapter.ChatMessageAdapter;
...
import com.wl.pluto.plutochat.chat.utils.KeyBoardUtils;
    ...
    public void onExpressionPress(String fileName) {
        ...
        if (mExpressionViewFlipper.getVisibility() == View.VISIBLE) {
            ...
            if (!DELETE_EXPRESSION.endsWith(fileName)) {
                ...
                try {
                    Class expressionClass = Class.forName("com.wl.pluto.plutochat.chat.utils.ExpressionUtils");
