...
public class UserContentProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI = Uri
            .parse("content://com.wl.pluto.plutochat.provider/elements");
    ...
    static {
        ...
        uriMatcher.addURI("com.wl.pluto.plutochat.provider", "elements", ALL_ROWS);

        // 以 elements/[rowID]　结尾的ＵＲＩ对应请求单行数据
        uriMatcher.addURI("com.wl.pluto.plutochat.provider", "elements/#", SINGLE_ROW);
    }
