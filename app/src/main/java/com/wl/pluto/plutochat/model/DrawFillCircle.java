...
public class DrawFillCircle extends DrawAction {
    ...
    public DrawFillCircle(int color, float x, float y, int size) {
        super(color);
    ...
    public void move(float x, float y) {
        ...
        mStopX = x;
        mStopY = y;
        mCircleRadius = (float) (Math
                .sqrt(((x - mStartX) * (x - mStartX) + (y - mStartY)
                        * (y - mStartY))) / 2.0);
    }
